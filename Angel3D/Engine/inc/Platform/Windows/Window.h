...
{
  class Window : public Engine::Core::BaseWindow
  {
    public:
      Window(const Engine::Core::WindowProps& f_props);
      virtual ~Window();
    ...
    private:
      virtual void Init(const Engine::Core::WindowProps& f_props);
      virtual void Shutdown();

      GLFWwindow* m_window;

      Engine::Core::Scope<Engine::Renderer::GraphicsContext> m_Context;
