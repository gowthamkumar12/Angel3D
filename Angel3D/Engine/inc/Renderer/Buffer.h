...
namespace Engine::Renderer
{
  ...
  class VertexBuffer
  {
    public:
      ...
      static Engine::Core::Ref<VertexBuffer> Create(uint32_t f_size);
      static Engine::Core::Ref<VertexBuffer> Create(float* f_Vertices, uint32_t f_size);
  };
  ...
  class IndexBuffer
  {
    public:
      ...
      static Engine::Core::Ref<IndexBuffer> Create(uint32_t* f_Indices, uint32_t f_count);
  };
} // namespace Engine::Renderer
